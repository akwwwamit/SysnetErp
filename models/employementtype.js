...
module.exports = (sequelize, DataTypes) => {
  class EmployementType extends Model {
    ...
    static associate(models) {
      EmployementType.belongsTo(models.Company, {
        foreignKey: 'company_id'
      });

      EmployementType.belongsTo(models.ApprovalStatus, {
        foreignKey: 'approval_status_id' 
      });
    }
  }
  EmployementType.init({
    id: {
    ...
    sequelize,
    modelName: 'EmployementType',
    tableName:'tbl_employement_types_mst',
    underscored:true,
    timestamps: true,
  });
